...
export const articleModify = async (id, title, content, description, tags, covers, status) => {
    return await request.postForm('/api/articles/modify', { id, title, content, description, tags, covers, status }, {
        formSerializer: {
            indexes: null
        }
    })
